<?php
/**
 * DSS05 Penilaian View
 * Form penilaian domain DSS05
 */
?>
<!-- Page Header -->
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <h4 class="page-title">
                <i class="bi bi-shield-lock me-2"></i>Penilaian DSS05
            </h4>
    ...
    <div class="col-12">
        <div class="content-card">
            <div class="content-card-body">
                <form method="GET" action="<?= BASE_URL ?>/penilaian/dss05" class="row g-3 align-items-end">
                    <div class="col-md-6">
...
<div class="row g-4">
    <div class="col-12">
        <form action="<?= BASE_URL ?>/penilaian/save-penilaian" method="POST">
            ...
            <input type="hidden" name="process_id" value="2">
            ...
            ?>
            <div class="question-card mb-4 border-success" id="question<?= $q['id'] ?>">
                <div class="question-header bg-success">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <span class="badge bg-dark me-2"><?= sanitize($q['kode_pertanyaan']) ?></span>
                            <span class="badge bg-light text-dark"><?= sanitize($q['komponen']) ?></span>
                        </div>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-4">
                <button type="submit" class="btn btn-success btn-lg">
                    <i class="bi bi-save me-2"></i>Simpan Penilaian DSS05
                </button>
            </div>
        </form>
    </div>
